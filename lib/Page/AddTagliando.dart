...
class AddTagliando extends StatefulWidget{
  ...
  @override
  State<AddTagliando> createState() => _AddTagliandoState(info);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Tagliando",style: TextStyle(color: Colors.blue.shade300)),
        centerTitle: true,
