              ...
              child: ElevatedButton(
                onPressed: () => {
                  /* if(image == null) {
                    ...
                    await FirebaseFirestore.instance.collection('CostiGenerali').doc('2022').collection(user.uid).doc('${months[current_month! - 1]}').update({"costo": sum1 + costoManutenzione!, "manutenzione": sum});
